...
class PanelInicio(ctk.CTkFrame):
    def __init__(self, master, sistema):
        ...
        # ==========================================
        # CARGA DE ÍCONOS SIMPLES (ASSETS)
        # ==========================================
        ...
        try:
            ...
            print(f"Aviso: No se encontraron las imágenes. Error: {e}")
        ...
        # Creamos las tres tarjetas pasándole su respectivo ícono
        self.crear_tarjeta(self.frame_tarjetas, "Clientes", total_clientes, "#1f6aa5", 0, icono_clientes)
        self.crear_tarjeta(self.frame_tarjetas, "Vehículos", total_vehiculos, "#2FA572", 1, icono_vehiculos)
